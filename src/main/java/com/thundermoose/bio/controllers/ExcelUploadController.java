...
public class ExcelUploadController {
  ...
  Upload loadRawData(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    dao.loadRawDataExcel(Utils.getCurrentUsername(), runName, controls, new FileInputStream(it.getStoreLocation()));
  ...
  private Upload loadViability(boolean linked, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (linked) {
      dao.loadLinkedViabilityExcel(username, runId, dao.getRawDataControlsForRun(runId, username), new FileInputStream(it.getStoreLocation()));
    } else {
      dao.loadIndependentViabilityExcel(username, runName, controls, new FileInputStream(it.getStoreLocation()));
    }

<div class="row" ng-controller="RawCtrl">
  <div class="span10">
    <h3>Upload independent viability data</h3>

    <form destination="b/doIndependentViabilityLoad" returnPath="/" name="form" upload-form novalidate>
  ...
  <div id="legend">
    ...
    <ol>
      ...
      <li>Define as many controls as you like</li>
